...
namespace CheckoutAppTests.Models
{
    ...
    public class SalePercentDecoratorTests
    {
        ...
        {
            var decorator = new SalePercentDecorator(_testItem, 1, 10);
        ...
        {
            var decorator = new SalePercentDecorator(_testItem, 1, 101);
        }

        [TestMethod]
        public void PriceForQuantity_OnNonEligibleQuantity_ShouldReturnActualPricing()
        {
            var decorator = new SalePercentDecorator(_testItem, 2, 10);
